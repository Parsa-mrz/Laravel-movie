                    ...
                    <form action="{{route('videos.update',$video->slug)}}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name='name' value="{{$video->name}}" class="form-control" placeholder="@lang('videos.name')">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" value="{{$video->description}}" name='description' rows="4" placeholder="@lang('videos.description')"></textarea>
                            </div>
                            <div class="col-md-2">
